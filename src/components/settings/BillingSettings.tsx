...
const mockInvoices: Array<{ date: string; total: string; status: string }> = []
      ...
      <Card className="space-y-4 p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-ink">—</h3>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-ink/10">
              {mockInvoices.length === 0 ? (
                <tr>
                  <td colSpan={4} className="py-8 text-center text-sm text-muted-ink">
                    No invoices found
                  </td>
                </tr>
              ) : (
